...
export function Problem (props) {
    ...
    let [initialValue, setInitialValue] = useState(props.initial)

    function add(){
        if (initialValue<props.max){
            initialValue++;
    ...
    return <div className="btn-group">
            <button type="button" className="btn btn-primary" onClick={subtract}>-</button>
            <span id="num_sel">{initialValue}</span>
