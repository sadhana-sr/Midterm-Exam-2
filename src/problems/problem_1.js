...
const explanation = `Because users are inputting the F value, we need to give the input a useRef. Because celsius is also being updated, it needs to be a state variable.`;
...
export function Problem () {
    ...
    return <>
        <label htmlFor='temp_f'>Enter a Fahrenheit temperature: </label><input id='temp_f' ref = {fRef} value={fahrenheit} onChange={fahrenheitUpdated} type='number' />
        <hr />
